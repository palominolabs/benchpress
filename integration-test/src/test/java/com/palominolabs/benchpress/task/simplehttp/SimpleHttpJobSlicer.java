...
final class SimpleHttpJobSlicer implements JobSlicer {
    @Nonnull
    @Override
    public List<JobSlice> slice(UUID jobId, int workers, String progressUrl, String finishedUrl,
        ...
        return newArrayList(
            new JobSlice(jobId, 1, new Task(SimpleHttpJobTypePlugin.TASK_TYPE, configNode), progressUrl, finishedUrl));
    }
}
